(() => {
  ...
  [
    ...
    {id:'band-assisted-pull-up',name:'Band Assisted Pull Up',equipment:'Resistance Band',muscles:['Back','Biceps'],primaryMuscle:'Back',secondaryMuscles:['Biceps'],filterMuscles:['Back','Biceps'],movement:'Vertical Pull',loadType:'assisted',aliases:['band assisted pull up','banded pull up','resistance band pull up','band pull up']},
