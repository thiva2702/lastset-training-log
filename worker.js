...
function injectPremiumLayer(html) {
  const headInject = `
<link rel="stylesheet" href="/lastset-theme.css?v=0126">
...
`;
  ...
  const bodyInject = `
<script src="/lastset-enhancements.js?v=0126"></script>
...
`;
  ...
  if (!output.includes("lastset-theme.css")) {
    ...
    if (!output.includes("lastset-hotfix.css")) {
      output = output.replace("</head>", `<link rel="stylesheet" href="/lastset-hotfix.css?v=0126">\n</head>`);
    }
    if (!output.includes("lastset-calendar.css")) {
      output = output.replace("</head>", `<link rel="stylesheet" href="/lastset-calendar.css?v=0126">\n</head>`);
    }
  }
  ...
  if (!output.includes("lastset-enhancements.js")) {
    ...
    if (!output.includes("lastset-hotfix.js")) {
      output = output.replace("</body>", `<script src="/lastset-hotfix.js?v=0126"></script>\n</body>`);
    }
    if (!output.includes("lastset-calendar.js")) {
      output = output.replace("</body>", `<script src="/lastset-calendar.js?v=0126"></script>\n</body>`);
    }
  }
